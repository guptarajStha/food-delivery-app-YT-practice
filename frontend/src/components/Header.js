  ...
  return (
    <div className='header h-[34vw] my-[30px] mx-auto bg-contain bg-no-repeat relative' style={{backgroundImage:`url('/header_img.png')`}}>
      <div className="header-content   absolute flex flex-col items-start bottom-[10%] left-[6vw] max-w-[50%]  gap-[1.3vw] animate-fadeIn">
        ...
        <p className=' hidden lg:flex text-white text-[1vw]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae ipsa quidem repudiandae id accusantium sit eum ratione voluptatem eos asperiores laborum, consequatur velit magni veritatis, impedit rerum perferendis, sunt itaque?</p>
